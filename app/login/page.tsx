...
export default function LoginPage() {
  ...
  async function onSubmit(data: LoginInput) {
    try {
      ...
      toast.error("ورود انجام نشد. دوباره تلاش کن.");
    }
  }
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              ...
              <h1 className="text-3xl font-black leading-tight text-foreground sm:text-4xl">
                دوباره برگرد به
                <span className="mx-2 text-primary-dark">خلوتت</span>
              </h1>

              <p className="mt-3 max-w-md text-sm leading-7 text-muted">
                نوشته‌ها، برنامه‌ها و فکرهات همون‌جایی هستن که گذاشتی.
              </p>
            </div>
              ...
              <div className="mb-8">
                ...
                <blockquote className="mt-6">
                  ...
                  <p className="text-2xl font-black leading-[1.9] text-foreground">
                    گاهی فقط کافیه چیزی که توی ذهنت مونده رو بنویسی؛ بقیه‌ش
                    آروم‌تر می‌شه.
                  </p>
                </blockquote>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-4xl border border-border bg-card/82 p-5 shadow-[0_20px_70px_rgba(94,58,47,0.08)]">
                  <div className="mb-5 flex items-center justify-between">
                    <div>
                      <p className="text-xs font-bold text-muted">صفحه خلوت</p>
                  ...
                  <div className="space-y-3">
                    {[
                      "یادداشت صبحگاهی",
                      "ایده‌ای که ذهنم رو گرفت",
                      "کاری که امروز باید انجام بدم",
                    ].map((text) => (
                      <div
                        key={text}
                        className="flex items-center gap-3 rounded-2xl border border-border bg-background/55 px-3.5 py-3"
                      >
                  ...
                  <div className="mt-5 rounded-2xl bg-background/70 p-4">
                    <p className="text-sm leading-7 text-muted">
                      لازم نیست همه‌چیز مرتب باشه؛ فقط از ذهنت بیاد بیرون.
                    </p>
                  </div>
                </div>
              </div>
